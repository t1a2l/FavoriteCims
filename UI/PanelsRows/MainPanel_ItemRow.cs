...
{
    public class MainPanel_ItemRow : UIListRow
    {
        public override float RowHeight => 40f;
        ...
        public override void Start()
        {
            ...
            try
            {
                ...
                CitizenSingleRowBGSprite = AddUIComponent<UITextureSprite>();
                CitizenSingleRowBGSprite.name = "FavCimsCitizenSingleRowBGSprite";
                CitizenSingleRowBGSprite.size = size;
                CitizenSingleRowBGSprite.AlignTo(this, UIAlignAnchor.TopLeft);
                ...
                CitizenSingleRowBGSprite.eventMouseLeave += delegate (UIComponent component, UIMouseEventParameter eventParam)
                {
                    CitizenSingleRowBGSprite.texture = FavDot;
                };
                CitizenHappinessPanel = AddUIComponent<UIPanel>();
                ...
                CitizenNamePanel = AddUIComponent<UIPanel>();
                ...
                CitizenNameButton.font = UIFonts.Regular;
                ...
                AgePhasePanel = AddUIComponent<UIPanel>();
                ...
                AgePhaseButton.font = UIFonts.Regular;
                ...
                RealAgePanel = AddUIComponent<UIPanel>();
                ...
                RealAgeButton.font = UIFonts.Regular;
                ...
                EducationPanel = AddUIComponent<UIPanel>();
                ...
                EducationButton.font = UIFonts.Regular;
                ...
                CitizenHomePanel = AddUIComponent<UIPanel>();
                ...
                CitizenHomeButton.font = UIFonts.Regular;
                ...
                WorkingPlacePanel = AddUIComponent<UIPanel>();
                ...
                WorkingPlaceButton.font = UIFonts.Regular;
                ...
                LastActivityPanel = AddUIComponent<UIPanel>();
                ...
                LastActivityButton.font = UIFonts.Regular;
                ...
                CloseRowPanel = AddUIComponent<UIPanel>();
        ...
        public override void Display(object data, int rowIndex)
        {
            try
            {
                var kvp = (KeyValuePair<InstanceID, string>)data;
                MyInstanceID = kvp.Key;
                citizenINT = (int)MyInstanceID.Citizen;
                CitizenNameText = MyInstance.GetName(MyInstanceID);
                MyInstancedName = kvp.Value ?? CitizenNameText;
                ...
                if (citizen != 0U && CitizenNameText == MyInstancedName)
                {
