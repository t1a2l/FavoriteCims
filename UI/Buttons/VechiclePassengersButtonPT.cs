...
namespace FavoriteCims
{
	public class VechiclePassengersButtonPT : UIButton
	{
        ...
        private FavCimsVechiclePanelPT VehiclePanel;
        ...
        public override void Start()
		{
			...
			base.size = new Vector2(36f, 32f);
			base.playAudioEvents = true;
			base.AlignTo(this.RefPanel, this.Alignment);
			base.tooltipBox = aview.defaultTooltipBox;
			bool flag = FavCimsMainClass.FullScreenContainer.GetComponentInChildren<FavCimsVechiclePanelPT>() != null;
			if (flag)
			{
		...
		public override void Update()
		{
			...
			if (!unLoading)
			{
				...
				if (isVisible)
				{
					...
					bool flag4 = !this.VehicleID.IsEmpty && VehicleID.Type == InstanceType.Vehicle;
					if (flag4)
					{
						base.isEnabled = true;
