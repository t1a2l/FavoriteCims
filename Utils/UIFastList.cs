...
namespace FavoriteCims.Utils
{
    ...
    public class UIFastList : UIComponent
    {
        ...
        private void UpdateScrollbar()
        {
            ...
            float scrollSize = height * height / (H);
            float amount = stepSize * height / (H);
        ...
        private void SetupControls()
        {
            ...
            tracSprite.atlas = GetAtlas("Ingame");
            ...
            thumbSprite.atlas = GetAtlas("Ingame");
